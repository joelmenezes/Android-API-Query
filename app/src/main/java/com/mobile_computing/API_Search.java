...
public class API_Search extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ((DatumAdapter) m_adapter).setOnItemClickListener(new DatumAdapter.DatumClickListener() {
            ...
            public void onItemClick(int position, View v) {
                Intent i = new Intent (self, ResultDisplayActivity.class);
                Datum mdt = ((DatumAdapter) m_adapter).getItem(position);
                i.putExtra("title", mdt.title());
                i.putExtra("date", mdt.date());
                i.putExtra("img", mdt.imageUrl());
                i.putExtra("text", mdt.text());
                startActivity(i);
    ...
    //Start new activity to show favorites
    public void openFavorites(View view){
        Intent f = new Intent (this, FavoriteDisplay.class);
        startActivity(f);
    }
}